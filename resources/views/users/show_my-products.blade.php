...
<main id="product-catalog-container" class="grow max-w-7xl mx-auto xl:mx-50 px-4 sm:px-6 lg:px-8 py-8 min-h-screen bg-brand-secondary">
  <div class="mt-6 mb-8 flex justify-between items-center">
    <div>
      <h1 class="mb-2 text-4xl font-serif scale-y-125 font-bold text-brand-main">Seller Dashboard</h2>
      <p class="text-brand-muted">Manage your products and services</p>
    </div>
    @auth
      <a href="{{ route('product.create') }}" wire:navigate class="btn btn-primary gap-2">
