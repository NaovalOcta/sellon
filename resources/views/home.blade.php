...
<main class="bg-brand-secondary min-h-screen">
  {{-- Hero Section --}}
  <section class="fade-in-effect relative overflow-hidden mx-auto md:mx-50">
  ...
  {{-- Value Props --}}
  <section class="invisible bg-white border-y border-slate-100 px-auto md:px-50">
  ...
  {{-- Featured Products --}}
  <section class="invisible max-w-7xl px-6 py-20 mx-auto md:mx-50">
    ...
    <div class="mt-10 text-center md:hidden">
      <a href="{{ route('product.catalog') }}" wire:navigate class="text-brand-accent font-bold hover:underline flex items-center justify-center gap-2">
  ...
  {{-- CTA Section --}}
  <section class="invisible bg-brand-main text-white py-24 px-auto md:px-50">
